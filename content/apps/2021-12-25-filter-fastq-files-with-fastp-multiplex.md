---
title: Filter multiple fastq files with FASTP in Ailio v2
author: Junli Zhang
date: '2021-12-25'
slug: filter-multiple-fastq-files-with-fastp-ailio-v2
categories:
  - Research
tags:
  - fastq
...
<div id="download-btn" style="display:none">
    ...
    <button id="download">Download the filtered fastq file(s)</button><br><br>
</div>
...
<script src="/tools/aioli/v2.4.0/aioli.js"></script>
<script src="/libs/FileSaver.min.js"></script>
<script src="/libs/jszip.min.js"></script>
<script src="/libs/pako_deflate.min.js"></script>
<script src="/libs/fastp-multiplex-v2.js" type="module"></script>